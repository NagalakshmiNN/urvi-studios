...
export default async function CheckoutPage() {
  ...
  // An account is no longer required up front — a logged-out visitor can
  // continue as a guest (CheckoutClient shows that choice below). Choosing
  // to login/register instead still returns here via ?next=/checkout, same
  // as before.
